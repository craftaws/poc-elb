...
import craftaws as poc

class DeployStage(core.Stage):
    def __init__(self, scope: core.Construct, id: str, **kwargs):
        super().__init__(scope, id, **kwargs)

        network = poc.network(self, 'network')
        poc.application_load_balancer(self, 'alb', target_vpc=network.vpc)
...
class CdkPipelineStack(core.Stack):
    def __init__(self, scope: core.Construct, id: str, params: dict, **kwargs):
        ...
        pipeline.add_application_stage(DeployStage(self, 'poc'))
